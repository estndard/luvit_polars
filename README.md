...
><span style="color:red;"> **※ 책과 노트북 파일에서 사용한 KOBIS 박스오피스 데이터는 과거 데이터도 계속 수정됩니다. 따라서 독자 여러분들꼐서 KOBIS 데이터를 다운받는 시점에 따라 책과 이 노트북의 결과와 다소 상이할 수 있습니다. 책에서 사용한 데이터는 2025년 11월 10일 다운로드 받은 데이터를 사용했습니다.** </span>
